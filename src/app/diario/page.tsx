        ...
        <CosmicBackground className="font-sans selection:bg-amber-500/30 selection:text-amber-200">
            <div className="w-full flex flex-col items-center relative z-10">
                    ...
                    <CosmicHeader className="pb-32 md:pb-40">
                        <div className="w-full px-4 sm:px-6 lg:px-8 pt-12 text-center md:text-left">
                            <div className="flex flex-col md:flex-row items-center md:items-start gap-5 mb-8 animate-divine">
                                ...
                                <div className="inline-flex items-center gap-2.5 px-4 py-1.5 bg-amber-500/10 border border-amber-400/20 rounded-full text-amber-600 dark:text-amber-300 text-[10px] font-black uppercase tracking-[0.2em] shadow-inner">
                                    <Feather className="w-3.5 h-3.5" />
                                    Diário de Favoritos
                                </div>
                            </div>

                            <h1 className="text-4xl md:text-6xl font-black tracking-tight text-text-primary mb-4 animate-divine text-center md:text-left">
                                Adicionar Mensagem
                            </h1>
                            <p className="text-text-muted max-w-2xl text-lg leading-relaxed animate-divine [animation-delay:200ms] text-center md:text-left mx-auto md:mx-0">
                ...
                <main className="w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 -mt-24 relative z-20 flex flex-col space-y-8 py-20">
                    ...
                    {/* Textarea Card */}
                    <div className="stellar-card rounded-[2.5rem] p-8 md:p-12 border border-border-subtle animate-divine">
                        ...
                        <textarea
                            ...
                            className="w-full h-64 bg-surface-2 border border-border-subtle rounded-2xl p-6 text-text-primary placeholder-text-muted focus:outline-none focus:border-amber-500/50 focus:ring-2 focus:ring-amber-500/20 transition-all resize-none text-lg leading-relaxed"
                        />
                        ...
                        <div className="mt-6">
                            ...
                            <select
                                ...
                                className="w-full px-4 py-3 bg-surface-2 border border-border-subtle rounded-xl text-text-primary focus:outline-none focus:border-amber-500/50 focus:ring-2 focus:ring-amber-500/20 transition-all cursor-pointer"
                            >
                                {CATEGORIAS.map((cat) => (
                                    <option key={cat.value} value={cat.value} className="bg-surface-1 text-text-primary">
                                        {cat.label}
                                    </option>
                                ))}
                            </select>
